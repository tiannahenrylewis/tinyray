...
class camera {
    ...
    private:
        ...
        void initialize() {
            ...
            //Calculage the vectors across the horizatonal and down the vertical viewport edges
            auto viewport_u = viewport_width * u; //Vector across viewport horixontal edge
        ...
        ray get_ray(int i, int j) const {
            //Construct a camera ray originatin from the origin and directed at randomly sampled point around the pixel location i, j
